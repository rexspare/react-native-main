...
class ParallaxHeader extends Component {
  ...
  getAnimatedValue() {
    return this.props.animatedValue || this.state.scrollY;
  }
  ...
  getHeaderHeight() {
    const scrollY = this.getAnimatedValue();
    return Animated.interpolate(scrollY, {
    ...
    return (
      <Animated.ScrollView
        ...
        onScroll={Animated.event(
          ...
          {
            listener: e => this.scrollListener(e.nativeEvent),
          },
        )}
        {...scrollViewProps}>
        <Box
